...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/entries/css/hw-style.css">
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/entries/css/subhome.css" >
  ...
  {scripts}
   <?php if($this->session->flashdata('success')) { ?>
    ...
    <?php } ?>
<script src="<?php echo base_url(); ?>assets/entries/js/show_homework/selector.js"></script>
