...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/entries/css/calnd-style.css">
  ...
  {scripts}
   <?php if($this->session->flashdata('success')) { ?>
    ...
    <?php } ?>
<script src="<?php echo base_url(); ?>assets/entries/js/calendar/selector.js"></script>
