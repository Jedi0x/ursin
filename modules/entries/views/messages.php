      ...
      <div class="container">
        ...
        <?php if(empty($notshowform)){ ?>
          ...
          <textarea name="message" id="message" cols="30" maxlength="800" rows="6" placeholder="Write your message" required></textarea>
            <p><input type="radio" id="recipient_identifier1" onclick="showmailcheckbox(this.value)" name="recipient_identifier" value="0" style="width: 15px;" required>  Publish to all my classes</p>
