      ...
      <div class="menu-area">
        <nav>
          <ul>
            ...
            <li id="ex-item"><a id="exm-active" href="<?php echo base_url('exams/exams'); ?>">Exams</a></li>
...
<form action="<?php echo base_url('exams/Exams/manage'); ?>" onsubmit="return checkvalidation_exam()" method="POST">
